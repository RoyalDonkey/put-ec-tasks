...
\begin{longtable}[c]{|c|cc|}
	...
	\hline
	\multirow{2}*{ils-steepest-random} & 74,893 (74,137--75,593) & 48,969 (48,662--49,308) \\
...
\begin{longtable}[c]{|c|cc|}
	...
	\hline
	\multirow{2}*{ils-steepest-random} & 16.335 (16.323--16.387) & 16.342 (16.323--16.395) \\
	& 16.333 (16.324--16.380) & 16.342 (16.323--16.403) \\
	\hline
	\caption{Average, minimum, maximum running times for MSLS and ILS (s)}
\end{longtable}
...
\begin{longtable}[c]{|c|cc|}
	...
	\hline
	\endhead
	\multirow{2}*{ils-steepest-random} & 1,149.3 (1,091--1,209) & 1,207.8 (1,139--1,249) \\
...
\visualization{TSPA}{ils-steepest-random}{74,137}

\subsection{TSPB.csv}
\visualization{TSPB}{msls-steepest-random}{67.828}
\visualization{TSPB}{ils-steepest-random}{67,676}

\subsection{TSPC.csv}
\visualization{TSPC}{msls-steepest-random}{48,311}
\visualization{TSPC}{ils-steepest-random}{48,662}

\subsection{TSPD.csv}
\visualization{TSPD}{msls-steepest-random}{45,075}
\visualization{TSPD}{ils-steepest-random}{45,016}
...
the flexibility of ILS (tweakable perturbation function and timeout), it is a
significantly more versatile approach, while still being very simple in its
concept.

Despite their promising results, both MSLS and ILS can't really be compared
with the previously tested techniques, due to the many times longer execution
time that was given to them. In the case of ILS, this could of course be
tweaked, but capping it at 1 linear search's time would make it identical to
just linear search. Both MSLS and ILS are really only viable as extensions to
